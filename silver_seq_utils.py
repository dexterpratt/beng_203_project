...
def load_silver_seq_data():
    counts_path = 'data/silver_seq_counts.txt'
    silver_seq_counts = pd.read_csv(counts_path, sep="\t")
    X = silver_seq_counts.astype(int)
    silver_seq_metadata = pd.read_excel('data/silver_seq_metadata.xlsx')
    #load additional metadata
    supp_df = pd.read_csv('data/additionalSupplementalInfo.txt', sep='\t')
